...
//    }
    ...
    table tb_per_flow_action {
        key = {
            eg_md.snap_0_read_min_l2[27:8]: range @name("snap_0"); //scale down to 16 bits
        ...
        const entries = {
            (0x0..0x7fff, 0x0..0x3ffff, 0x0): trigger_report(); 
            (0x0..0x7fff, 0x0..0x3ffff, 0x1): trigger_report(); 
            (0x0..0x7fff, 0x0..0x3ffff, 0x2): trigger_report(); 
            (0x0..0x7fff, 0x0..0x3ffff, 0x3): trigger_report(); 
        }
        */
